...
describe DeepL::DocumentApi do
  ...
  describe '#translate_document' do
    it 'Translates a document from a filepath' do
      ...
      DeepL.document.translate_document(example_document_path(source_lang), output_document_path,
                                        source_lang, target_lang, input_file_name, {})
    ...
    it 'Translates a document using the lower-level methods and returns the correct status' do # rubocop:disable RSpec/ExampleLength
      ...
      handle = DeepL.document.upload(example_document_path(source_lang), source_lang, target_lang,
                                     input_file_name, {})
